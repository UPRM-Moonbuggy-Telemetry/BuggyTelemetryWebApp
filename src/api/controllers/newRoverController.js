...
const NewRover = require('../models/dataModel.js').NewRover;
...
exports.getLastValues = function (req, res) {
    ...
    .then(dataRows => {
        console.log('Successfully fetched the most recent 30 data rows of New Rover.');
        res.status(200).send(dataRows);
    })
    .catch(error => {
        console.log(('Could not fetch the 30 most recent data rows of New Rover.') + error);
        res.status(404).send(req.body);
    });
};
...
exports.addData = function (req, res) {
    ...
    _.forEach(req.body, function (value) {
        ...
        'strain_backseat_1': value.strain_backseat_1,
        'strain_backseat_2': value.strain_backseat_2,
        'strain_backseat_3': value.strain_backseat_3,
        ...
        'vibration_center_back': value.vibration_center_back,
...
exports.updateDataById = function (req, res) {
    ...
    'strain_backseat_1': req.body.strain_backseat_1,
    'strain_backseat_2': req.body.strain_backseat_2,
    'strain_backseat_3': req.body.strain_backseat_3,
    ...
    'vibration_center_back': req.body.vibration_center_back,
